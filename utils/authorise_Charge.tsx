...
// var utils = require('./authorise_util');

// export function chargeCreditCard(callback: (obj:any) => void) {
// 	var merchantAuthenticationType = new ApiContracts.MerchantAuthenticationType();
// 	merchantAuthenticationType.setName(process.env.AUTHORISE_API_LOGIN_KEY);
// 	merchantAuthenticationType.setTransactionKey(process.env.AUTHORISE_TRANSACTION_KEY);
