...
const page: FC<pageProps> = ({}) => {
  ...
  return (
    <PageWrapper className="absolute top-0 left-0 w-full h-screen flex items-center justify-center ">
      ...
      <div className="border-0 rounded-md p-2 mt-6 shadow-2xl w-[95%] h-[70vh] md:h-[85%] max-w-5xl md:w-full bg-lightMainBG/70 dark:bg-darkMainBG/70 backdrop-blur-md">
