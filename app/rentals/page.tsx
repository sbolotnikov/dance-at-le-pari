...
const page: FC<pageProps> = ({}) => {
  ...
  return (
    <PageWrapper className="absolute top-0 left-0 w-full h-screen flex items-center justify-center">
      ...
      <div className="border-0 rounded-md p-2 mt-2  shadow-2xl w-[90%] max-w-[450px] flex justify-center items-center flex-col  h-[70svh] md:h-[90%] md:w-full bg-lightMainBG/70 dark:bg-darkMainBG/70 backdrop-blur-md">
