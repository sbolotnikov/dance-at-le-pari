...
const page: FC<pageProps> = ({}) => {
  ...
  return (
    <PageWrapper className="absolute top-0 left-0 w-full h-screen flex items-center justify-center">
      ...
      {revealGallery && <FullScreenGalleryView pictures={picturesArray} 
      onReturn={()=>{ 
        sleep(1200).then(() => {
...
<Iframe url="https://www.youtube.com/embed/oiF1NnGzUiM?autoplay=1&amp;mute=1&amp;controls=1&amp;loop=0&amp;origin=https%3A%2F%2Fwww.leparidancenter.com&amp;playsinline=1&amp;enablejsapi=1&amp;widgetid=3"
        width="100%"
        height="100%"
