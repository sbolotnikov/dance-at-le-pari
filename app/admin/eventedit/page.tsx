  ...
  return (
    <PageWrapper className="absolute top-0 left-0 w-full h-screen flex items-center justify-center">
      ...
      {revealTemplateEdit == true ? (
        ...
        <div className="   shadow-2xl w-[90%]  max-w-[450px] md:w-full h-[70vh] md:h-[90%] bg-lightMainBG/70 dark:bg-darkMainBG/70 backdrop-blur-md border-0 rounded-md  p-2 mt-6">
