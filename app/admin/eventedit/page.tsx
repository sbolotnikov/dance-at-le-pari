        ...
        <div className="   shadow-2xl w-[90%]  max-w-[450px] md:w-full bg-lightMainBG/70 dark:bg-darkMainBG/70 backdrop-blur-md border rounded-md border-lightMainColor dark:border-darkMainColor p-1 m-1">
          <div className="border rounded-md border-lightMainColor dark:border-darkMainColor p-1">
            ...
            <div className="flex flex-col justify-center items-center border border-lightMainColor dark:border-darkMainColor rounded-md p-1 m-1">
              <label className="flex flex-row cursor-pointer justify-center text-center items-start"
              onClick={(e) => {
                e.preventDefault();
                console.log('click');
              ...
              <div className=" h-4 w-4 md:h-5 md:w-5 m-2 fill-lightMainColor  stroke-lightMainColor dark:fill-darkMainColor dark:stroke-darkMainColor ">
                {complexEvent?<ShowIcon icon={'Checkmark'} stroke={'0.5'} />:<ShowIcon icon={'Close'} stroke={'0.5'} />}
              </div>  
                Event with Assigned seats
              </label>
              {complexEvent==true &&<div className="w-full">
                <div className="w-full h-20 flex  justify-center items-center">
