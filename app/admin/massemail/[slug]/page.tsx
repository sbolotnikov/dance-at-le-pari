...
export default function Page(params: { params: { slug: string } }) {
    ...
    fetch('/api/admin/contacts_pull', {
      ...
      res
        ...
        .then((data) => {
          ...
          sendConsecativeEmails(emailList, htmlContent, [] as string[], 1, 1);
        })
        .catch((err) => {
          console.log(err);
        });
  ...
  const sendTestEmail = (email: string) => {
    console.log('exportHtml', htmlContent);
    ...
    <PageWrapper className="absolute top-0 left-0 w-full h-screen flex items-center md:items-end justify-center">
      ...
      >
        ...
        >
          <div
            id="containedDiv"
            className={`absolute top-0 left-0 flex flex-col p-1 justify-center items-center`}
          >
            <h2
