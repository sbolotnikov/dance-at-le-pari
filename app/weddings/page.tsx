      ...
      >
        ...
        <BoxClickable title="When To Start Taking Wedding Dance Lessons. How Many Lessons I need?">
          <p className="mt-4">
            ...
            consideration for couples preparing for their big day. Let’s break
            it down:
          </p>
          <ol className="list-decimal list-inside">
            <li className="m-2">
              <b>Early Start:</b> Starting wedding dance lessons{' '}
              <b>sooner rather than later</b> is advisable. If you begin early,
              you’ll have time to learn the dance, practice, and build
              confidence. You can then continue practicing on your own. However,
              waiting until the last minute can be risky—you might run out of
              time before the wedding.
            </li>
            <li className="m-2">
              <b>Dance Complexity:</b> Consider how involved you want your dance
              to be:
              <ol className="m-2 list-disc">
                {' '}
                <li className="m-4">
                  <b>Basic Step:</b> If you’re aiming for a simple dance, just
                  learning the basic step that matches your chosen music can be
                  accomplished in as little as <b>one lesson</b>. It may take a
                  few more lessons to feel comfortable.
                </li>
                <li className="m-4">
                  <b>Variations:</b> To add some flair, learn variations like
                  turns, twinkles, and walk-arounds. These can be sprinkled
                  throughout your dance. Loose choreography with variations
                  typically takes <b>2 to 5 lessons.</b>
                </li>
                <li className="m-4">
                  <b>Special Entrance and Pose:</b> For a more elaborate dance,
                  choreograph a special entrance, intersperse variations, and
                  end with a final pose or dip. This semi-choreographed format
                  usually requires <b>3 to 8 lessons.</b>
                </li>
              </ol>
            </li>
            <li className="m-2">
              <b>Fully Choreographed Routine:</b> If you want a{' '}
              <b>fully choreographed wedding dance routine</b>, where every step
              is planned from start to finish, the number of lessons can vary:
              <ol className="m-2 list-disc">
                {' '}
                <li className="m-4">
                  <b>Minimum:</b> At least <b>10 lessons</b> are needed to learn
                  a full routine.
                </li>
                <li className="m-4">
              ...
              <ol className="m-4 list-disc">
                ...
                <li className="m-2">
                  ...
                  <ol className="m-2 list-square">
                    ...
                    <li className="m-2">
                      <b>Fully Choreographed Routine:</b> Six months or more.
                    </li>
                  </ol>
                  <li className="m-2">
          ...
          <p className="mb-4">Remember, starting early allows you to enjoy the process, build confidence, and create a memorable dance for your special day. So don’t wait— <b>get started on your wedding dance today!</b>💃🕺🎶</p>
        </BoxClickable>
