...
const page: FC<pageProps> = ({}) => {
  ...
  return (
    <PageWrapper className="absolute top-0 left-0 w-full h-screen flex items-center justify-center">
      ...
      <div
        className="blurFilter border-0 rounded-md p-4  shadow-2xl w-[90%] max-h-[760px] overflow-y-auto max-w-[450px] md:w-full bg-lightMainBG/70 dark:bg-darkMainBG/70"
