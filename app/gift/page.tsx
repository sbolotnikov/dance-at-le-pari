...
const page = (props: Props) => {
  ...
  return (
    <PageWrapper className="absolute top-0 left-0 w-full h-screen flex items-center justify-center">
      ...
      <div className="blurFilter border-0 rounded-md p-2 shadow-2xl w-[90%] max-w-[850px] max-h-[85%] overflow-y-auto md:w-full md:mt-8 bg-lightMainBG/70 dark:bg-darkMainBG/70">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full h-auto">
              <div className="w-full md:w-1/2  flex flex-col justify-center items-center">
                  ...
                  onClick={() => {
                    const p1 = {
                      ...
                      price: priceOptions
                        ...
                        : 0,
                      tag: priceOptions ? priceOptions[choosenOption].tag : '',
                      amount: 1,
                      seat: null,
                      table: null,
                      date: null,
                ...
                {session && session.user.role == 'Admin' && (
                  <div className="w-24">
                    <div onClick={() => {setRevealCloud(true)}}>
                    ...
                    onClick={() => {
                      if (priceOptions !== null) {
                        ...
                        fetch('/api/admin/update_gift_certificates', {
                          ...
                          body: JSON.stringify({
                            giftCertificates: JSON.stringify({priceOptions,img}),
                          }),
                        })
                          .then((res) => res)
                          .then((res) => {
