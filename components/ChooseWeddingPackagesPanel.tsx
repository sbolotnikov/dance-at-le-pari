...
const ChooseWeddingPackagesPanel = ({
  specialPackage,
  ...
  return (
    <div className="absolute top-0 left-0 inset-0 flex justify-center items-center ">
      <div className="w-full flex flex-col justify-center items-center">
        ...
        {selectedProducts.length !== 0 && specialProduct !== -1 && (
          <button
            ...
            onClick={async () => {
              ...
              const res = await fetch('/api/admin/update_wedding_packages', {
                ...
                body: JSON.stringify({
                  specialPackage: specialProduct,
                  weddingPackages: selectedProducts,
                }),
              });
              loadingState(false);
            }}
